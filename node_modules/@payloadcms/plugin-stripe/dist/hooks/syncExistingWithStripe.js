    ...
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0:
                ...
                if (logs)
                    payload.logger.info("A '".concat(collectionSlug, "' document has changed in Payload with ID: '").concat(originalDoc === null || originalDoc === void 0 ? void 0 : originalDoc._id, "', syncing with Stripe..."));
                if (!!data.stripeID) return [3 /*break*/, 1];
            ...
            case 1:
                if (logs)
                    payload.logger.info("- Syncing to Stripe resource with ID: '".concat(data.stripeID, "'..."));
                _c.label = 2;
            case 2:
                _c.trys.push([2, 4, , 5]);
                return [4 /*yield*/, ((_b = stripe === null || stripe === void 0 ? void 0 : stripe[syncConfig === null || syncConfig === void 0 ? void 0 : syncConfig.stripeResourceType]) === null || _b === void 0 ? void 0 : _b.update(data.stripeID, syncedFields))];
            case 3:
